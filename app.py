...
<head>
<meta charset="UTF-8">
<title>Trade Report {d}{header_u}</title>
<style>
...
<div class="no-print" style="margin-top:10px; margin-bottom:14px; background:#f9f9f9; padding:12px; border-radius:6px; border:1px solid #ddd; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  ...
  <div style="display:flex; flex-wrap:wrap; gap:8px;">
    <div style="display:flex; flex-direction:column; gap:2px;">
      <label style="font-size:10px; color:#888; font-weight:600;">Report Date</label>
      <input type="date" id="f-date" value="{d}" onchange="changeReportDate(this.value)" style="font-size:11px; padding:4px 8px; border-radius:4px; border:1px solid #ccc; outline:none; background:#fff; cursor:pointer; font-weight:500;">
    </div>
    <div style="display:flex; flex-direction:column; gap:2px;">
...
<div class="footer">Generated by Trade Analyser {APP_VERSION} &nbsp;&#8226;&nbsp; {d}</div>

<script>
var _root = '{root}';
function changeReportDate(val) {{
  if(!val) return;
  window.location.href = _root + '/report?date=' + val;
}}
